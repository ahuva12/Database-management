...
function remove_dislapy_form(type_button){
...
function removeMemberFromDisplay(memberId) {
    ...
    if (memberDiv) {
        memberDiv.remove(); // Remove the member div from the display
    } else {
...
function displayUpdateForm(member) {
    ...
    updateForm.querySelector('#vaccine_1_manufacturer').value = member.vaccine_1_manufacturer;
    updateForm.querySelector('#vaccine_2_date').value = ChangeToformatDate(member.vaccine_2_date);
    updateForm.querySelector('#vaccine_2_manufacturer').value = member.vaccine_2_manufacturer;
    updateForm.querySelector('#vaccine_3_date').value = ChangeToformatDate(member.vaccine_3_date);
    updateForm.querySelector('#vaccine_3_manufacturer').value = member.vaccine_3_manufacturer;
    updateForm.querySelector('#vaccine_4_date').value = ChangeToformatDate(member.vaccine_4_date);
    updateForm.querySelector('#vaccine_4_manufacturer').value = member.vaccine_4_manufacturer;
